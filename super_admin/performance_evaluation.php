...
$hrName = $hrData ? $hrData['First_Name'] . ' ' . $hrData['Last_Name'] : 'Super Admin';

$profileStmt = $conn->prepare("SELECT Profile_Pic FROM users WHERE User_ID = ?");
$profileStmt->execute([$_SESSION['user_id']]);
$profileData = $profileStmt->fetch(PDO::FETCH_ASSOC);
$hrProfile = ($profileData && !empty($profileData['Profile_Pic']) && file_exists($profileData['Profile_Pic'])) ? $profileData['Profile_Pic'] : '../images/default_profile.png';
...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column mt-4">
            <li class="nav-item"><a href="superadmin_dashboard.php" class="nav-link"><span class="material-icons">dashboard</span><span>Dashboard</span></a></li>
            <li class="nav-item"><a href="payroll.php" class="nav-link"><span class="material-icons">payments</span><span>Payroll</span></a></li>
    ...
    <div class="main-content" id="main-content">
        <div class="header">
            ...
            <a href="profile.php" class="user-profile" id="userProfile" style="color:black; text-decoration:none;"><span><?php echo htmlspecialchars($hrName); ?></span><img src="<?php echo $hrProfile; ?>" alt="User Profile"></a>
        </div>
    ...
    <div class="mobile-nav">
        <div class="mobile-nav-container">
            <a href="superadmin_dashboard.php" class="mobile-nav-item"><span class="material-icons">dashboard</span><span class="mobile-nav-text">Dashboard</span></a>
            <a href="payroll.php" class="mobile-nav-item"><span class="material-icons">payments</span><span class="mobile-nav-text">Payroll</span></a>
