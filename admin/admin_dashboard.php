...
if (!validateSession($conn, 2)) { // 2 = admin role
...
<head>
    ...
    <title>Admin Dashboard - Green Meadows Security Agency</title>
...
<body>
    ...
    <div class="mobile-nav">
        <div class="mobile-nav-container">
            <a href="admin_dashboard.php" class="mobile-nav-item active">
                <span class="material-icons">dashboard</span>
