...
// Allow only guards (Role_ID = 5); validateSession handles redirects
...
<body>
    <div class="container-xxl py-4">
        <div class="d-flex justify-content-end mb-3">
            <a href="guards_dashboard.php" class="btn btn-outline-secondary btn-sm"><span class="material-icons" style="font-size:18px; vertical-align:middle;">arrow_back</span> Back</a>
        </div>
