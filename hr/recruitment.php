<?php
// filepath: c:\xampp\htdocs\HRIS\hr\recruitment.php
session_start();
...
try {
    ...
    // Set HR name and profile picture
    $hrName = $hrData['First_Name'] . ' ' . $hrData['Last_Name'];
    $hrProfile = !empty($hrData['Profile_Pic']) ? $hrData['Profile_Pic'] : '../assets/images/profile.jpg';
} catch (PDOException $e) {
    // Set defaults if query fails
    $hrName = "HR Staff";
    $hrProfile = "../assets/images/profile.jpg";
    $hrData = [
        'First_Name' => '',
        'Last_Name' => ''
    ];
                                ...
                                <div class="card h-100 application-card">
                                    ...
                                    <div class="card-footer bg-white border-top-0">
                                        <div class="d-flex justify-content-between gap-2">
                                            <button class="btn btn-sm btn-outline-primary view-applicant flex-fill" data-id="<?php echo $applicant['Applicant_ID']; ?>">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item update-status" data-id="<?php echo $applicant['Applicant_ID']; ?>" data-status="New" href="#">
                                                        <span class="badge status-new me-2">●</span> New
                                                    </a></li>
                                                    <li><a class="dropdown-item update-status" data-id="<?php echo $applicant['Applicant_ID']; ?>" data-status="Contacted" href="#">
                                                        <span class="badge status-contacted me-2">●</span> Contacted
                                                    </a></li>
                                                    <li><a class="dropdown-item update-status" data-id="<?php echo $applicant['Applicant_ID']; ?>" data-status="Interview Scheduled" href="#">
                                                        <span class="badge status-interview me-2">●</span> Interview Scheduled
                                                    </a></li>
